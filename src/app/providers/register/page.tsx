      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        ...
        <div>
          ...
          <h1 className="text-lg font-extrabold text-center text-blue-700 mb-6 dark:text-blue-400">
            Join TrueFirms to be found by millions of potential prospects
          ...
          >
            ...
            {passwordStrength && !errors.password && (
              <p
                className={`mt-1 text-sm ${passwordStrength === "Strong" ? "text-green-600" : passwordStrength === "Moderate" ? "text-yellow-600" : "text-red-500"}`}
              >
            ...
            <ReCAPTCHA
              ref={recaptchaRef}
              sitekey="6LfAknsrAAAAACIjv5bso0G3OWzo4GLFqFMYJfwd"
          ...
          <p className="text-sm text-justify tracking-normal leading-relaxed mb-2">
            By signing in you agree to our user{" "}
            <a className="text-blue-500">agreement</a> and{" "}
            <a className="text-blue-500">privacy policy.</a>
          </p>
          <p className="text-base  tracking-normal leading-relaxed mb-2">
            <strong>Kindly Note:</strong> we solely accept agencies that are
            recognized as legitimate and professional. To assess the eligibility
            of your profile for publication on TrueFirms, we will conduct a
            review of your website, portfolio, online reputation, and reviews.
          </p>
        </div>
      </div>
    </div>
