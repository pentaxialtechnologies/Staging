...
export default function CreateJobForm() {
    ...
    try {
      ...
      if (form.key_responsibilities) {
        const contentState = convertFromRaw(
          JSON.parse(form.key_responsibilities),
        );
      ...
      if (form.technical_skills) {
        ...
        if (isMounted)
          setSkillState(EditorState.createWithContent(contentState));
      }
    } catch (error) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const payload = {
      ...
      job_dates: {
        start_date: form.job_dates.start_date
          ? new Date(form.job_dates.start_date)
          : null,
      },
      location: {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              value={
                form.job_dates.start_date
                  ? form.job_dates.start_date.toISOString().split("T")[0]
                  : ""
              }
              onChange={handleChange}
              className="w-full rounded-md border border-gray-300 px-4 py-2"
    ...
    />
        ...
        <div>
          ...
          >
            ...
            <option value="I am not sure at this point">
        ...
        <div className="max-w-md mx-auto">
          ...
          <select
            ...
            onChange={handleChange}
            value={form.timezone}
            className="max-w-md mx-auto px-0 mt-1 py-2 rounded border border-gray-400"
          >
            ...
            <option value="(UTC+03:00) Asia/Aden">(UTC+03:00) Asia/Aden</option>
            ...
            <option value="(UTC+04:00) Asia/Baku">(UTC+04:00) Asia/Baku</option>
            ...
            <option value="(UTC+09:00) Asia/Dili">(UTC+09:00) Asia/Dili</option>
            ...
            <option value="(UTC+02:00) Asia/Gaza">(UTC+02:00) Asia/Gaza</option>
            ...
            <option value="(UTC+07:00) Asia/Hovd">(UTC+07:00) Asia/Hovd</option>
            ...
            <option value="(UTC+06:00) Asia/Omsk">(UTC+06:00) Asia/Omsk</option>
            <option value="(UTC+05:00) Asia/Oral">(UTC+05:00) Asia/Oral</option>
        ...
        <div>
          ...
          >
            ...
            <option value="Service Provider Agency Location">
              Service Provider Agency Location
            </option>
          </select>
        </div>
        <div>
