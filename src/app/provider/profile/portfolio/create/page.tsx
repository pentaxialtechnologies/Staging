...
const Page = () => {
  ...
  const removeProjectLink = (index: number) => {
    const UpdatedLinks = portfolioData.project_link.filter(
      (_, i) => i !== index,
    );
    setPortfolioData((prev) => ({ ...prev, project_link: UpdatedLinks }));
  };
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col mt-6">
            ...
            <select
              ...
              value={portfolioData.project_category}
              onChange={handleInputChange}
            >
          ...
          <div className="flex flex-col mt-6">
            ...
            <select
              name="project_cost"
              className="w-full border rounded px-3 py-2"
              value={portfolioData.project_cost}
              onChange={handleInputChange}
            >
          ...
          <button
            type="submit"
            className="px-4 py-2 bg-green-500 text-white mt-6"
          >
            Submit
          </button>
        </form>
