            ...
            <div>
                ...
                <div>
                  {user && (
                    <Image
                      ...
                      width={200}
                      height={100}
                      className="rounded-full w-25 h-auto "
                    />
                  )}
                </div>
                <div>
                  ...
                  <button
                    onClick={() => router.push("/provider/editProfile")}
                    className="px-4 py-2 bg-orange-400 text-white mt-3 rounded-full hover:cursor-pointer"
                  >
                    {" "}
                    Edit Profile
                  </button>
              ...
              <div className="flex items-center justify-between mt-8 bg-white shadow-md border p-4 border-gray-300">
                ...
                <div className="flex flex-row items-center justify-center gap-2">
                  ...
                  <button
                    className=""
                    onClick={() => router.push("/provider/edit_company_email")}
                  >
                    <ArrowRight size={16} />
                  </button>
                </div>
              ...
              <div className="flex items-center justify-between mt-8 bg-white shadow-md border p-4 border-gray-300">
                <div>
                  ...
                  <p className="text-xl">
                    Changing your password regularly reduces your risk.
                  </p>
                </div>
                ...
                <div className="flex flex-row items-center justify-center gap-2">
                  <button
                    onClick={() =>
                      router.push("/provider/change_company_password")
                    }
                  >
                    <ArrowRight size={16} />
                  </button>
